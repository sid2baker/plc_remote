defmodule PlcRemoteSystemRpi4.MixProject do
  use Mix.Project

  @app :plc_remote_system_rpi4
  @source_url "https://github.com/nerves-project/nerves_system_rpi4"
  ...
  defp description do
    "Nerves System for PLC Remote on the Waveshare IPCBOX-CM5-A with CM4"
  end
  ...
  defp package do
    [
      ...
      links: %{
        "Upstream Nerves System" => @source_url,
        "IPCBOX-CM5-A Hardware" => "https://github.com/waveshareteam/IPCBOX-CM5-A",
        "REUSE Compliance" =>
