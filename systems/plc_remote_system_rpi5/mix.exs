defmodule PlcRemoteSystemRpi5.MixProject do
  use Mix.Project

  @app :plc_remote_system_rpi5
  @source_url "https://github.com/nerves-project/nerves_system_rpi5"
  ...
  defp description do
    "Nerves System for PLC Remote on the Waveshare IPCBOX-CM5-A"
  end
